<div>
    ...
    <script>
        ...
        document.addEventListener('livewire:load', function() {
                    ...
                    plugins: {
                        annotation: {
                            annotations: {
                                line1: {
                                    type: 'line',
                                    yMin: <?php echo $xVbase; ?>,
                                    yMax: <?php echo $xVbase; ?>,
                                    borderWidth: 2,
                                    borderColor: 'grey'
                                },
                                line2: {
                                    type: 'line',
                                    yMin: <?php echo $xVwarn; ?>,
                                    yMax: <?php echo $xVwarn; ?>,
                                    borderWidth: 2,
                                    borderColor: 'blue'
                                },
                                line3: {
                                    type: 'line',
                                    yMin: <?php echo $xValarm; ?>,
                                    yMax: <?php echo $xValarm; ?>,
                                    borderWidth: 2,
                                    borderColor: 'red'
                                },
                            }
            ...
            Livewire.on('sensorDataUpdated', function(data,xValarm, xVwarn, xVbase, latestXvel, xVelTime, olddata) {
                ...
                fetch('http://127.0.0.1:8000/api/sensor-data/x-vel/' + selectedSensorValue)
                    ...
                    .then(data => {
                        ...
                        if (arraysEqual(initialDataFromBackend, reconstructedData)) {
                            xveltime.innerHTML = data[0].x;
                            latestxvel.innerHTML = data[0].y;
                        } else {
                            xveltime.innerHTML = data[0].x;
                            latestxvel.innerHTML = data[0].y;
            ...
            setInterval(function() {
                ...
                if (parseFloat(latestxvel.innerHTML) > parseFloat(<?php echo $xValarm; ?>)) {
                    blinkingIcon.style.color = isHidden ? 'transparent' : 'red';
                } else if (parseFloat(latestxvel.innerHTML) > parseFloat(<?php echo $xVwarn; ?>)) {
