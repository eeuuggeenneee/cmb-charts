        ...
        <div class="col-4">
            <div class="card mb-5">
                <div class="card-header d-flex align-items-center">
                    ...
                    <span class="display-4 ml-auto" style="font-size: 1rem;"><strong>{{ $zVelTime }}</strong></span>
                </div>
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            Livewire.on('sensorDataUpdated', function(data, zValarm, zVwarn, zVbase) {
                ...
                updateChart(data, zValarm, zVwarn, zVbase);
            });

            function updateChart(data, zValarm, zVwarn, zVbase) {
                chart = new Chart(ctx, {
                    type: 'line',
                    data: {
                        datasets: [{
