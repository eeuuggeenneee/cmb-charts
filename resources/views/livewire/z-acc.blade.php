<div>
            ...
            <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">
                        ...
                        <span class="display-4"><strong><span id="latestzacc"></span>g</strong></span>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-xl-8 col-sm-12">
            <div class="card">
                <div class="card-header" style="display: flex; align-items: center; justify-content: space-between;">
                    ...
                    <span style="text-align: left;">Z Acceleration</span>
    ...
    <script>
        ...
        document.addEventListener('livewire:load', function() {
            ...
            Livewire.on('sensorDataUpdated', function(data, zAalarm, zAwarn, zAbase, latestZacc, zAccTime,
                olddata) {
            ...
            var zacctime = document.getElementById("zacctime");
            var latestzacc = document.getElementById("latestzacc");
                ...
                fetch('http://172.31.7.14:8000/api/sensor-data/z-acc/' + selectedSensorValue)
                    ...
                    .then(data => {
                        ...
                        if (arraysEqual(initialDataFromBackend, reconstructedData)) {
                            zacctime.innerHTML = data[0].x;
                            latestzacc.innerHTML = data[0].y;
                        } else {
                            zacctime.innerHTML = data[0].x;
                            latestzacc.innerHTML = data[0].y;
            ...
            setInterval(function() {
                ...
                if (parseFloat(latestzacc.innerHTML) > parseFloat(<?php echo $zAalarm; ?>)) {
                    blinkingIcon.style.color = isHidden ? 'transparent' : 'red';
                } else if (parseFloat(latestzacc.innerHTML) > parseFloat(<?php echo $zAwarn; ?>)) {
